...
public class ClockView extends View {
    ...
    private static final float TEXT_LOCATION_Y = 0.7f;
...
//        HandlerThread tmpthread = new HandlerThread("TEMP") ;
//        final Handler tmphandler = new Handler(tmpthread.getLooper()){
//            public void handlemessage(Message msg){
//                super.handleMessage(msg) ;
//                tmphandler.sendEmptyMessageDelayed(1,1000) ;
//
//            }
//        };
...
//    }
    ...
    private void drawText(Canvas canvas){
        ...
        canvas.drawText(""+time.getHours()+":"+time.getMinutes()+":"+time.getSeconds(),centerX-radius*0.2f,centerY+TEXT_LOCATION_Y*radius,textPaint);
    }
    ...
    private void drawTimeNeedles(Canvas canvas) {
        ...
        int hourDegree = ( (hour-3)*30+minute/2+360 )%360;
        ...
        int minuteDegree = ( (minute-15)*6+360)%360;
        ...
        int secondDegree = ((second-15)*6+360)%360;
